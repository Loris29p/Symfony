...
class __TwigTemplate_56b79075631d3e1ffcc02bd0064f4d60 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["user"]) {
            ...
            echo "</td>
                <td>";
            // line 27
            ((twig_get_attribute($this->env, $this->source, $context["user"], "dateNaiss", [], "any", false, false, false, 27)) ? (print (twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, $context["user"], "dateNaiss", [], "any", false, false, false, 27), "Y-m-d"), "html", null, true))) : (print ("")));
            echo "</td>
                <td>";
            // line 28
...
{% endblock %}
", "user/index.html.twig", "/Applications/MAMP/htdocs/Symfony/templates/user/index.html.twig");
    }
}
